...
My interests span AI/ML systems, cybersecurity, and infrastructure automation. When I'm not coding, you'll find me competing in cyber competitions, optimizing my homelab, or experimenting with local AI.
...
- **Hardware**: Dell PowerEdge R720 server cluster
- **Virtualization**: Proxmox VE for VM orchestration
- **Storage**: TrueNAS for centralized data management
- **Monitoring**: Grafana + Prometheus dashboards
- **Networking**: VLANs, pfSense firewall, network segmentation
- **Services**: Self-hosted apps, local AI inference, container orchestration
...
- 🔐 Sharpening cybersecurity skills through competitions and CTFs
- 🏗️ Expanding homelab infrastructure with advanced monitoring
- 🤖 Experimenting with local LLM deployments and optimization
...
I'm always interested in collaborating on AI, cybersecurity, or infrastructure projects. Feel free to reach out!
